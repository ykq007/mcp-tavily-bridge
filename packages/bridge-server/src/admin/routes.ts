...
export function registerAdminRoutes(app: Express, prisma: PrismaClient) {
  ...
  app.get('/admin/keys', requireAdmin, asyncHandler(async (req, res) => {
  ...
  app.get('/admin/keys/:id/reveal', requireAdmin, asyncHandler(async (req, res) => {
  ...
  app.post('/admin/keys', requireAdmin, asyncHandler(async (req, res) => {
  ...
  app.patch('/admin/keys/:id', requireAdmin, asyncHandler(async (req, res) => {
  ...
  app.post('/admin/keys/:id/refresh-credits', requireAdmin, asyncHandler(async (req, res) => {
    const ip = typeof req.ip === 'string' ? req.ip : null;
    const userAgent = typeof req.headers['user-agent'] === 'string' ? req.headers['user-agent'] : null;
  ...
  app.post('/admin/keys/sync-credits', requireAdmin, asyncHandler(async (req, res) => {
    const ip = typeof req.ip === 'string' ? req.ip : null;
    const userAgent = typeof req.headers['user-agent'] === 'string' ? req.headers['user-agent'] : null;
  ...
  app.delete('/admin/keys/:id', requireAdmin, asyncHandler(async (req, res) => {
    try {
  ...
  app.get('/admin/tokens', requireAdmin, asyncHandler(async (req, res) => {
  ...
  app.post('/admin/tokens', requireAdmin, asyncHandler(async (req, res) => {
  ...
  app.post('/admin/tokens/:id/revoke', requireAdmin, asyncHandler(async (req, res) => {
  ...
  app.delete('/admin/tokens/:id', requireAdmin, asyncHandler(async (req, res) => {
    try {
      // Delete related ResearchJob records first to avoid FK constraint
  ...
  app.get('/admin/audit-logs', requireAdmin, asyncHandler(async (req, res) => {
  ...
  app.get('/admin/usage', requireAdmin, asyncHandler(async (req, res) => {
    const page = parseInt(req.query.page as string) || 1;
  ...
  app.get('/admin/usage/summary', requireAdmin, asyncHandler(async (req, res) => {
    const dateFrom = req.query.dateFrom as string | undefined;
    const dateTo = req.query.dateTo as string | undefined;
