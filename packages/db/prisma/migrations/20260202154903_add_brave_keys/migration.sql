...
-- CreateIndex
CREATE UNIQUE INDEX "BraveKey_label_key" ON "BraveKey"("label");

-- CreateIndex
CREATE INDEX "BraveKey_status_lastUsedAt_idx" ON "BraveKey"("status", "lastUsedAt");
